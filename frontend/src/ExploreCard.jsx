          ...
          <div className="flex-1">
            <div className="flex justify-between items-start">
              <div>
                ...
                <div className="flex items-center my-1 text-sm my-2">
                  <span className="text-yellow-400">★</span>
                  <span className="ml-1 font-medium">4.5/5</span>
                  <div className="ml-2 flex gap-1 items-center bg-green-50 rounded-full ml-2 border p-1"> <User className='w-4 h-4'/> {756} Sessions done</div>
                </div>
              </div>
            </div>

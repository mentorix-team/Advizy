            ...
            <div className="flex items-start justify-between">
              <div className="space-y-1 sm:space-y-2">
                ...
                <p className="text-[13px] sm:text-[15px]">
                  Starts at{" "}
                  <span className="text-[#0049B3] font-medium">Rs. {startingPrice}</span>{" "}
                  for{" "}
                  <span className="text-[#0049B3] font-medium">{duration} min</span>
                </p>
              </div>
          ...
          <div className="flex gap-2 w-full sm:w-auto">
            ...
            <button
                 onClick={() => {
                  ...
                  document.getElementById('services-offered').scrollIntoView({ behavior: 'smooth' });
                }}

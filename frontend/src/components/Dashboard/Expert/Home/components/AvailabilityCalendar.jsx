...
export default function AvailabilityCalendar({
  ...
  const filteredMeetings = meetings.filter((meeting) => {
    ...
    if (!Array.isArray(daySpecificData)) {
      console.warn(
        "⚠️ daySpecific is not an array! Converting to array:",
        daySpecificData
      );
    ...
    <div className="bg-white border rounded-lg shadow-sm p-4 sm:p-6">
      <div className="flex justify-between items-center mb-6">
        ...
        <ArrowUpRight
          ...
          className="cursor-pointer w-4 h-4 text-gray-800"
        />
      </div>
      ...
      <div className="flex flex-col lg:flex-row gap-6">
          ...
          <div className="grid grid-cols-7 gap-[2px] text-center">
            {Array.from({ length: 42 }, (_, i) => {
              ...
              const hasMeetings = meetings.some((meeting) => {
                ...
                return daySpecificData.some(
                  (daySpec) =>
                    new Date(daySpec.date).toDateString() ===
                      date.toDateString() && daySpec.slot?.startTime
                );
              });
              ...
              return (
                <div
                  ...
                  className={`py-2 text-sm cursor-pointer transition-colors
                    ...
                    ${
                      isToday
                        ? "text-[#388544] font-bold border border-gray-400 rounded-md bg-[#F5FEF8]"
                        : ""
                    }
        ...
        <div className="flex-1">
          ...
          <h3 className="font-medium mb-4">
            Meetings for {selectedDate.toLocaleDateString("en-GB")}
          </h3>

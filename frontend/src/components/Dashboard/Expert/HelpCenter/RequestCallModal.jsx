...
function RequestCallModal({ isOpen, onClose }) {
          ...
          {!submitted ? (
            <>
              <div className="bg-green-50 border-l-4 border-green-500 p-4 mb-6">
                <h3 className="text-lg font-medium text-green-700">Need Assistance?</h3>
                <p className="text-green-600">Our team will get back to you shortly.</p>
              </div>
            ...
            <div className="text-center py-10">
              ...
              <p className="text-gray-600">
                Thank you for your request. Our team will call you back shortly at {formData.phoneNumber}.
              </p>
            </div>
          )}
        </div>

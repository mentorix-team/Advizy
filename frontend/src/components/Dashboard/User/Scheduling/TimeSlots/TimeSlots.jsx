...
function TimeSlots({
  ...
  useEffect(() => {
    ...
    const now = new Date();
    const noticePeriodMinutes =
      parseInt(
        selectedAvailability.availability.reschedulePolicy.noticeperiod
      ) || 0;
    const bookingPeriodMonths =
      parseInt(selectedAvailability.availability.bookingperiod) || 0;
    ...
    dayData.slots.forEach((slot) => {
      ...
      const end = new Date(selectedDate);
        ...
        isEndPM && endHour !== 12 ? endHour + 12 : endHour,
        endMinute,
        0,
        0
      );
      ...
      currentTime.setMinutes(
        Math.ceil(currentTime.getMinutes() / batchSize) * batchSize,
        0,
        0
      );

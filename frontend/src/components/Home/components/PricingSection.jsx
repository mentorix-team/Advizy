    ...
    <>
      <div className="grid grid-cols-1 gap-6">
        ...
        <div className="bg-white rounded-lg p-8 border border-[#E8F5E9] relative">
          ...
          <div className="mb-6">
            <h3 className="text-xl font-semibold text-[#1D2939] mb-2">Standard Commission</h3>
          ...
          <ul className="space-y-4 mb-8">
            ...
            <CircleCheckBig className='text-green-800 w-4 h-4' />
              ...
              <span className="text-gray-600 text-sm">10% commission on earnings</span>
            </li>
            <li className="flex items-center gap-3">
            <CircleCheckBig className='text-green-800 w-4 h-4' />

              <span className="text-gray-600 text-sm">No upfront costs or monthly fees</span>
            </li>
            <li className="flex items-center gap-3">
            <CircleCheckBig className='text-green-800 w-4 h-4' />

              <span className="text-gray-600 text-sm">Access to all platform features</span>
            </li>
            <li className="flex items-center gap-3">
            <CircleCheckBig className='text-green-800 w-4 h-4' />

              <span className="text-gray-600 text-sm">Maximize your earnings potential</span>
            </li>
          </ul>
          <button

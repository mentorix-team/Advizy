...
import { regenerateOtpEmail, validateOtpEmail, validateOtpMobile } from "../../Redux/Slices/authSlice";
import toast from "react-hot-toast";
import OTPInput from "@/utils/otpInput/OtpInput.util";

const VerifyAccountMobile = ({ onClose, onSwitchView, contactInfo }) => {
  ...
  const handleSubmit = async (e) => {
    ...
    const response = await dispatch(validateOtpMobile({ otp }));

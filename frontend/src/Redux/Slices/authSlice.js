...
export const loginaccount = createAsyncThunk("auth/login",async(data,{rejectWithValue})=>{
    try {
...
export const logout = createAsyncThunk("auth/logout",async function(data,{rejectWithValue}){
    try {
...
export const forgotOtpWithEmail = createAsyncThunk("auth/forgotOtpWithEmail",async(data,{rejectWithValue})=>{
    try {
...
export const generateOtpWithEmail = createAsyncThunk("auth/generateOtpWithEmail",async(data,{rejectWithValue})=>{
    try {

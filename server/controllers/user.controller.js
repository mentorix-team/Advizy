  ...
  try {
    ...
    if (user) {
      ...
      if (existingUserByEmail) {
        ...
        const errorURL = `https://www.advizy.in/auth-error?message=${encodeURIComponent(
    ...
    const frontendURL = `https://www.advizy.in/google-auth-success?token=${accessToken}&user=${encodeURIComponent(
      JSON.stringify(user)

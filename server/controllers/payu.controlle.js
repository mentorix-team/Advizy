...
export const verifyPayUPayment = async (response) => {
    try {
        const hashString = `${response.key}|${response.txnid}|${response.amount}|${response.productinfo}|${response.firstname}|${response.email}|${response.serviceId}|${response.expertId}|${response.userId}|${response.date}|||||||`;

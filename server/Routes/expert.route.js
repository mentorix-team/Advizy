...
router.post('/editExpertCerti',isLoggedIn,upload.single('certificate'),isExpert,editExpertCertificate)
router.post('/deleteExpertCerti',isLoggedIn,isExpert,deleteExpertCertificate)

router.post('/expertExperience',upload.single('document'),isLoggedIn,isExpert,expertexperience)
router.post('/editExpertExperience',upload.single('document'),isLoggedIn,isExpert,editExpertExperience)
router.post('/deleteExpertExperience',isLoggedIn,isExpert,deleteExpertExperience)
...
router.post('/editExpertEducation',upload.single('certificate'),isLoggedIn,isExpert,editSingleExpertEducation)
router.post('/deleteExpertEducation',isLoggedIn,isExpert,deleteExpertEducation)
